...
#查询数据库 train
lr_user_brand_train <- dbGetQuery(con,'SELECT 
a.user_id,
a.brand_id,
                                  lastday,
                                  month_count,
...
head(lr_user_brand_train)
save(lr_user_brand_train,file ='data/lr_user_brand_train.RData')
write.csv(lr_user_brand_train,file="data/lr_user_brand_train.csv")


#查询数据库 train
lr_user_brand_test <- dbGetQuery(con,'SELECT 
a.user_id,
a.brand_id,
                                 lastday,
                                 month_count,
...
lr_user_brand_test[is.na(lr_user_brand_test)] = 0
head(lr_user_brand_test)
save(lr_user_brand_test,file ='data/lr_user_brand_test.RData')
write.csv(lr_user_brand_test,file="data/lr_user_brand_test.csv")